...
check "FUSSBALL.DE-Live-Modus standardmäßig deaktiviert" sh -c "$COMPOSE exec -T web /app/scripts/entrypoint.sh python -c 'from app.config import get_settings; assert not get_settings().fussball_live_test_enabled'"
